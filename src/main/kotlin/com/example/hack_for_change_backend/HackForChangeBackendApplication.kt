...
class HackForChangeBackendApplication {
    ...
    fun init(userService: UserService, eventService: EventService, postService: PostService) = CommandLineRunner {
        ...
        userService.signUpUser(user1, 1)
        userService.signUpUser(user2, 1)
        userService.signUpUser(user3, 1)
        userService.signUpUser(user4, 1)
        userService.signUpUser(user5, 1)
        userService.signUpUser(user6, 1)
        userService.signUpUser(user7, 1)
        userService.signUpUser(user8, 1)
        userService.signUpUser(user9, 1)
        userService.signUpUser(user10, 1)
        userService.signUpUser(user11, 1)
        userService.signUpUser(user12, 1)
        userService.signUpUser(user13, 1)
